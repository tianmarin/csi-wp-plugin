...
public function __construct(){
	...
	$this->crt_tbl_sql_wt	="
		(
			...
			cmp_finished_end_flag boolean null COMMENT 'Indicates if status must be considered as finished tasks depending on its end_datetime value',
			cmp_error_flag boolean null COMMNET 'Indicates if status must be considered to get error tasks',
