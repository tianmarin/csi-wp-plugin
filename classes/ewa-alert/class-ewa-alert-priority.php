...
class NOVIS_CSI_EWA_ALERT_PRIORITY_CLASS extends NOVIS_CSI_CLASS{
...
public function __construct(){
	...
	$this->class_name	= 'ewa_alert_priority';
	...
	$this->crt_tbl_sql_wt	="(
								...
								value tinyint(1) unsigned not null COMMENT 'Priority Value',
								short_name varchar(20) not null COMMENT 'Name of priority',
								icon varchar(50) null COMMENT 'Icon of priority',
								hex_color varchar(6) null COMMENT 'HEX Color of Priority',
								reference_link tinytext null COMMENT 'URL of Priority Def',
...
global $NOVIS_CSI_EWA_ALERT_PRIORITY;
$NOVIS_CSI_EWA_ALERT_PRIORITY =new NOVIS_CSI_EWA_ALERT_PRIORITY_CLASS();
?>