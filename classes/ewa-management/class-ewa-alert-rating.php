...
class NOVIS_CSI_EWA_ALERT_RATING_CLASS extends NOVIS_CSI_CLASS{
...
public function __construct(){
	...
	$this->class_name	= 'ewa_alert_rating';
	//Nombre singular para títulos, mensajes a usuario, etc.
	$this->name_single	= 'Rating de Alerta';
	//Nombre plural para títulos, mensajes a usuario, etc.
	$this->name_plural	= 'Rating de Alerta';
	...
	$this->crt_tbl_sql_wt	="(
								...
								alert_rating varchar(1) not null COMMENT 'SAP rating char',
...
$NOVIS_CSI_EWA_ALERT_RATING =new NOVIS_CSI_EWA_ALERT_RATING_CLASS();
?>