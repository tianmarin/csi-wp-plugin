...
class NOVIS_CSI_EWA_STATUS_CLASS extends NOVIS_CSI_CLASS{
...
public function __construct(){
	...
	$this->class_name	= 'ewa_status';
	//Nombre singular para títulos, mensajes a usuario, etc.
	$this->name_single	= 'Status de EWA';
	//Nombre plural para títulos, mensajes a usuario, etc.
	$this->name_plural	= 'Status de EWA';
