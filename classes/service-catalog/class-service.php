...
public function __construct(){
	...
	$this->crt_tbl_sql_wt	="
		(
			...
			short_name_es varchar(150) not null COMMENT 'Spanish service name',
			short_name_en varchar(150) not null COMMENT 'English service name',
			url varchar(150) null COMMENT 'Url of service description',
			service_category_id tinyint(2) null COMMENT 'ID of service category',
