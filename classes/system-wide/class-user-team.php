...
class NOVIS_CSI_USER_TEAM_CLASS extends NOVIS_CSI_CLASS{
...
public function __construct(){
	...
	$this->class_name	= 'user_team';
	//Nombre singular para títulos, mensajes a usuario, etc.
	$this->name_single	= 'Equipo';
	//Nombre plural para títulos, mensajes a usuario, etc.
	$this->name_plural	= 'Equipos';
	...
	$this->crt_tbl_sql_wt	="
		(
			...
			country_id tinyint(2) unsigned not null COMMENT 'Id of team country',
...
$NOVIS_CSI_USER_TEAM =new NOVIS_CSI_USER_TEAM_CLASS();
?>
