<?php
/*
* Template Name: CSI Project Request
*
...
<body class="csi-template csi-template-cmp-control-center-body">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php _e(trailingslashit(get_permalink())); ?>" title="Project Management">
					<i class="fa fa-folder"></i> Solicitudes de Proyecto
	...
	<article id="csi-template-pm-project-request-main" style="min-height:100vh;" class="csi-template-main-content" data-default-action="csi_pm_project_request_build_page_intro">
	</article>
