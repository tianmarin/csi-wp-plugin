...
<body class="csi-template csi-template-cmp-control-center-body">
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<a class="navbar-brand" href="<?php _e(trailingslashit(get_permalink())); ?>" title="Project Management">
					...
					<strong class="text-danger">Novis</strong> Project Management
	...
	<article id="csi-template-pm-control-center-main" style="min-height:100vh;" class="csi-template-main-content" data-default-action="csi_pm_build_page_intro">
	</article>
